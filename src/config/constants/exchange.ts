...
import { bscTokens, bscTestnetTokens, baseTestnetTokens, USDC, USDT, BUSD } from '@pancakeswap/tokens'
import { ChainMap, ChainTokenList } from './types'

export const ROUTER_ADDRESS: ChainMap<string> = {
  [ChainId.ETHEREUM]: '0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D',
  [ChainId.GOERLI]: '0x9FbB9753a565F4a30cF14c62F2B1ab7B24F4d9Cd',
  [ChainId.BSC]: '0x10ED43C718714eb63d5aA57B78B54704E256024E',
  [ChainId.BSC_TESTNET]: '0xCc7aDc94F3D80127849D2b41b6439b7CF1eB4Ae0',
  [ChainId.BASE_TESTNET]: '0x24041Ba60Cb73C2652e563169a785AbF31fDF20F',
}
...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...
  [ChainId.BASE_TESTNET]: [baseTestnetTokens.weth],
}
